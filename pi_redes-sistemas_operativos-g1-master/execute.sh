...
do
    ...
    do
        gnome-terminal -e "bash -c \" python3 Intra_provincial_router.py $index_provincial $index_cantonal; exec bash\"" 
    done
done
...
do 
    ...
    do
        ...
        do
            gnome-terminal -e "bash -c \" python3 Server.py $index_provincial $index_cantonal $index_area; exec bash\"" 
        done
    done
done
